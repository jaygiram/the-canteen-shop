...
return true;
  ...
  <div class="sign-popup text-center"  style="background-image: linear-gradient( #88bced, #d7a5f9);">
 <div class="aside_box">
  <img class="aside1" src="assets/images/Ellipse 1.png">
  <img class="aside2" src="assets/images/whitelogo png.png">
</div>
...
.aside1{
    ...
    position: absolute;
    hight: 1000px;
    margin: 32px -520px 10px;
    wight: 10%;
}
.aside2{
    
  
    margin: 284px 34px 47px -483px;
    max-width: 100%;
    position: absolute;
